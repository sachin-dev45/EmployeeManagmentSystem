      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-3">
        ...
        <li class="nav-item">
         <Link to='/addemployee'>Add Employee</Link>
          ...
          <li class="nav-item">
         <Link to='/getemployee'>View Employee</Link>
        </li>
        <li class="nav-item">
         <Link to='/updateleavestatus'>update Leavestatus</Link>
        </li>
          <li class="nav-item">
        ...
        <li class="nav-item">
          <span style={{"fontSize":"12px","color":"info","backgroundColor":"whitesmoke"}} className='nav-link'>welcome {user.firstname} {user.lastname} </span>
        </li>
        <li class="nav-item">
