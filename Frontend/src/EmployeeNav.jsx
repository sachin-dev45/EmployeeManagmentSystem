    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-3">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
         <Link to='/leaveapplication'>Apply Leave</Link>
        </li>
         <li class="nav-item">
         <Link to='/viewleavedetails'> Show Leavedetails</Link>
        </li>
        ...
        <li class="nav-item">
        <span className='nav-link' style={{"fontSize":"12px","color":"info", "backgroundColor":"whitesmoke"}}>Welcome {user.firstname} {user.lastname}</span>
